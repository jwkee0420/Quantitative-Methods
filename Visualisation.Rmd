...
tm_shape(res2021) +
  ...
  tm_layout(title = "Hot and cold spots of Casualty Location Rate", 
...
t1 <- tm_shape(res2021) +
  ...
  tm_layout(title = "Hot and cold spots of Casualty Rate (2021)", 
            ...
            title.position = c("center", "top"))
t1
tmap_save(t1, 'Hot and cold spots of Casualty Rate (2021).png')
```
...
tmap_save(t2, 'Hot and cold spots of Casualty Length Rate (2021).png')
t2
```
...
tmap_save(t3, 'Hot and cold spots of Casualty Rate (2022).png')
t3
```
...
tmap_save(t4, 'Hot and cold spots of Casualty Length Rate (2022).png')
t4
...
tmap_save(t5, 'Hot and cold spots of Casualty Rate (2023).png')
t5
```
...
tmap_save(t6, 'Hot and cold spots of Casualty Length Rate (2023).png')
t6
```
